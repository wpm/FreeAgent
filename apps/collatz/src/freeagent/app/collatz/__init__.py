...
extends it by exactly one Collatz step, sending the longer chain back as its own request (the
...
agent has finished. Collatz doubles as the validation of the entry-point loading story:
